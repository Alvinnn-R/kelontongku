                            ...
                            <tbody>
                              @forelse ($barang as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->harga }}</td>
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('barangs.destroy', $data->id) }}" method="POST">
                                            <a href="{{ route('barangs.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
